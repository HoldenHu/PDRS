...
def main():
    ...
    for config in config_list:
        ...
        if not os.path.exists(result_dir):
            ...
            '''
            print('> [main]<model setting> kbatch_size = {}, klr = {}, klatent_dim = {}, kl2_reg = {}, knum_layers = {}, kdropout = {}'.format(kbatch_size, klr, klatent_dim, kl2_reg, knum_layers, kdropout))
            model = KnowledgeMLP(data_splitter.n_knowledge,klatent_dim, num_layers=knum_layers, dropout=kdropout)
            model.to('cuda:0')
