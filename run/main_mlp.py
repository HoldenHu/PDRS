...
def main():
    ...
    for config,var in zip(config_list, variant_list):
        ...
        user_num = data_splitter.n_user
        item_num = data_splitter.n_item
        print('> [main] FINISHED data loading(): overall user number: {}, overall item number: {}'.format(user_num, item_num))
        ...
        if not os.path.exists(result_dir):
            ...
            model = MLP(user_num, item_num, latent_dim, num_layers=num_layers, dropout=dropout)
            model.to('cuda:0')
